...
testHelpers.makeTests("can-stache-bindings - colon - element", function(name, doc, enableMO, testIfRealDocument){
	...
	if(enableMO) {
		canTestHelpers.dev.devOnlyTest("Semaphore cyclic avoidance throws warning when child is out of sync", function() {
			...
			var finishErrorCheck = canTestHelpers.dev.willWarn(message);
